        ...
        <DescriptionContainer>
          <DescriptionList>
            <LeftContainer>
              ...
              <DescriptionListItem>
                <Location>Sutton, England, United Kingdom</Location>
              </DescriptionListItem>
            </LeftContainer>
            <RightContainer>
              <ShareContainer>
                <DescriptionListItem>
                  <ShareSvg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="presentation" focusable="false">
                    <g fill="none">
